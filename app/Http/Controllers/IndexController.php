...
class IndexController extends Controller
{
    ...
    public function index(){
        ...
        $phim_hot=Movie::with('episode')->where('phim_hot',1)->where('status',1)->where('hide_or_show',1)->orderBy('date_updated','DESC')->get();
        ...
        return view('pages.home',compact('category','country','genre','phim_hot','phim_hot_sidebar','phim_sap_chieu','title'));    
    }
    public function movieByCategory($slug){
        ...
        $phim_hot_sidebar=Movie::with('view')->where('phim_hot',1)->where('hide_or_show',1)->whereNotIn('status',[0])->orderBy('date_updated','DESC')->take(5)->get();
        $phim_sap_chieu=Movie::where('status',0)->where('hide_or_show',1)->orderBy('date_updated','DESC')->take(5)->get();
        return view('pages.category',compact('category','country','genre','slug_cate','movies','phim_hot_sidebar','phim_sap_chieu','title'));
    }
    public function movieByCountry($slug){
        ...
        return view('pages.country',compact('category','country','genre','slug_country','movies','phim_hot_sidebar','phim_sap_chieu','title'));
    }
    public function movieByGenre($slug){
        ...
        return view('pages.genre',compact('category','country','genre','slug_genre','movies','phim_hot_sidebar','phim_sap_chieu','title'));
    }
    public function movieDetail($slug){
        ...
        return view('pages.movie',compact('category','country','genre','movie','related','phim_hot_sidebar','phim_sap_chieu','episode','episode_first','count_episode','review','title'));
    }
    public function watchMovie($slug,$tap){
        ...
        return view('pages.watch',compact('category','country','genre','movie','phim_hot_sidebar','phim_sap_chieu','episode','related','title'));
    }
    public function movieTag($tag){
        ...
        $phim_sap_chieu=Movie::where('status',0)->where('hide_or_show',1)->orderBy('date_updated','DESC')->take(5)->get();
        $title=$tag;
        return view('pages.tag',compact('category','country','genre','tag','movies','phim_hot_sidebar','phim_sap_chieu','title'));
    }
    public function movieByDirectorOrActor($type,$name,$id){
        ...
        return view('pages.director_actor',compact('category','country','genre','type','name','movies','phim_hot_sidebar','phim_sap_chieu','title'));
    }
    ...
    public function search(){
        if(isset($_GET['q'])){
            ...
            $phim_sap_chieu=Movie::where('status',0)->where('hide_or_show',1)->orderBy('date_updated','DESC')->take(5)->get();
            $title='Tìm kiếm phim';
            return view('pages.search',compact('category','country','genre','movies','phim_hot_sidebar','phim_sap_chieu','search','title'));
        }else{
